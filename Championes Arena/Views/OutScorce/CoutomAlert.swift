...
open class SweetAlert: UIViewController {
    ...
    fileprivate func setupContentView() {
        contentView.backgroundColor = Yellow_Dark
        ...
        contentView.backgroundColor = Yellow_Dark
        contentView.layer.borderColor = UIColor.colorFromRGB(0xFCD534).cgColor
    ...
    fileprivate func setupSubtitleTextView() {
        ...
        subTitleTextView.textColor = UIColor.black//.colorFromRGB(0x797979)
        subTitleTextView.isEditable = false
        subTitleTextView.backgroundColor = UIColor.white
    }
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        _ = showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: UIColor.black)//.colorFromRGB(0xAEDEF4))
            //.colorFromRGB(0xAEDEF4))
        userAction = action
        return self
    }
...
class SuccessAnimatedView: AnimatableView {
    ...
    var path: CGPath {
        let path = UIBezierPath()
        let startAngle:CGFloat = CGFloat((60) / 180.0 * Double.pi) //60 //M_PI
